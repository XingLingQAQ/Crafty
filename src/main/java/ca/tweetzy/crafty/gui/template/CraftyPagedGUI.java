...
public abstract class CraftyPagedGUI<T> extends BaseGUI {
	...
	public CraftyPagedGUI(Gui parent, @NonNull final Player player, @NonNull String title, int rows, @NonNull List<T> items) {
	...
	public CraftyPagedGUI(@NonNull final Player player, @NonNull String title, int rows, @NonNull List<T> items) {
